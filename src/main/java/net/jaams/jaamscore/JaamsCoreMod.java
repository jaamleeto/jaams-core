...
@Mod("jaams_core")
public class JaamsCoreMod {
	public static final Logger LOGGER = LogManager.getLogger(JaamsCoreMod.class);
	public static final String MODID = "jaams_core";
