package net.jaams.jaamscore.client.model;
...
public class Modelsteve_model<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("jaams_core", "modelsteve_model"), "main");
	...
	public Modelsteve_model(ModelPart root) {
